...
export const pawnData: Pawn[] = [
   ...
   },
   {
      ...
      approvedAt: new Date(),
      approvedBy: "SM CMK",
      draftData: generateDraftData("J2CE432608310005", new Date().toISOString(), 1, 1)
   },
   {
      ...emptyPawnFields,
      id: 6,
      ...
      customerId: 1,
      barangCodes: ["ITEM-260901-0001"],
      totalAppraisalPrice: 6000000,
      totalMaximumLoan: 5000000,
      nilaiPinjaman: 2500000,
      disburseNominal: 2400000,
      idPawnTenor: "1",
      tenor: 15,
      biayaAdmin: 35000,
      storageInsuranceFeePercentage: 0.06,
      persentaseBiayaPerawatan: 0.0075,
      tanggalTransaksi: new Date("2026-09-15T00:00:00"),
      statusNotification: "gadai_ulang",
      remark: "Test gadai ulang",
      appraisal: 6000000,
      bankId: 1,
      metodePencairan: "Transfer",
      nomorRekening: "0011223344",
      namaPemilikRekening: "BCA Simulator A",
      createdAt: new Date("2026-09-15T00:00:00"),
      createdBy: "Test User",
      approvedAt: new Date("2026-09-15T00:00:00"),
   ...
   },
   {
      ...
      customerId: 2,
      barangCodes: ["ITEM-260901-0001"],
      totalAppraisalPrice: 7500000,
      totalMaximumLoan: 6000000,
      nilaiPinjaman: 3500000,
      disburseNominal: 3350000,
      idPawnTenor: "1",
      tenor: 15,
      biayaAdmin: 35000,
      storageInsuranceFeePercentage: 0.06,
      ...
      nomorRekening: "0099887766",
      namaPemilikRekening: "Bank Simulator A",
      createdAt: new Date("2026-09-10T00:00:00"),
      createdBy: "Test User",
      approvedAt: new Date("2026-09-10T00:00:00"),
      approvedBy: "Store Manager",
   },
   {
      ...emptyPawnFields,
      ...
      remark: "Test tanpa status dan overdue",
      appraisal: 5000000,
      bankId: 1,
      metodePencairan: "Transfer",
      nomorRekening: "0011223344",
      ...
      createdBy: "Test User",
      approvedAt: new Date("2026-08-01T00:00:00"),
      approvedBy: "Store Manager",
   },
   {
      ...emptyPawnFields,
      id: 9,
      type: "J2C",
      applicationNumber: "J2CE432608310009",
      pawnNumber: "PWN-260901-0009",
      dibuatOleh: "JR CMK",
      status: "disbursed",
      customerId: 4,
      barangCodes: ["ITEM-260901-0001"],
      totalAppraisalPrice: 8500000,
      totalMaximumLoan: 7000000,
      nilaiPinjaman: 4200000,
      disburseNominal: 4050000,
      idPawnTenor: "1",
      tenor: 15,
      biayaAdmin: 35000,
      storageInsuranceFeePercentage: 0.06,
      persentaseBiayaPerawatan: 0.0075,
      tanggalTransaksi: new Date("2026-09-21T00:00:00"),
      statusNotification: "bayar_sebagian",
      remark: "Test bayar sebagian",
      appraisal: 8500000,
      bankId: 2,
      metodePencairan: "Transfer",
      nomorRekening: "0099887766",
      namaPemilikRekening: "Bank Simulator A",
      createdAt: new Date("2026-09-21T00:00:00"),
      createdBy: "Test User",
      approvedAt: new Date("2026-09-21T00:00:00"),
      approvedBy: "Store Manager",
   }
];
