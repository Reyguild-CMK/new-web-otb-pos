...
function ToastViewport({ className, ...props }: ToastPrimitive.Viewport.Props) {
  return (
    <ToastPrimitive.Viewport
      ...
      className={cn(
        "pointer-events-none fixed top-[calc(var(--navbar-height)+24px)] right-8 z-[100] w-[90vw] sm:w-[380px] outline-none",
        className
      )}
      {...props}
    />
  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        ...
        "data-limited:opacity-0 data-starting-style:[transform:translateY(-100%)] data-starting-style:opacity-0 data-starting-style:scale-95",
        "[&[data-ending-style]:not([data-limited]):not([data-swipe-direction])]:[transform:translateY(-100%)] [&[data-ending-style]]:opacity-0 [&[data-ending-style]]:scale-95",
